...
lib/src/phy/sync/test/CMakeFiles/sync_test.dir/sync_test.c.o: ../lib/src/phy/sync/test/sync_test.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object lib/src/phy/sync/test/CMakeFiles/sync_test.dir/sync_test.c.o"
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/sync_test.dir/sync_test.c.o   -c /local/srsLTE/lib/src/phy/sync/test/sync_test.c
...
lib/src/phy/sync/test/CMakeFiles/sync_test.dir/sync_test.c.i: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /local/srsLTE/lib/src/phy/sync/test/sync_test.c > CMakeFiles/sync_test.dir/sync_test.c.i
...
lib/src/phy/sync/test/CMakeFiles/sync_test.dir/sync_test.c.s: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /local/srsLTE/lib/src/phy/sync/test/sync_test.c -o CMakeFiles/sync_test.dir/sync_test.c.s
...
lib/src/phy/sync/test/sync_test: lib/src/phy/sync/test/CMakeFiles/sync_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable sync_test"
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/sync_test.dir/link.txt --verbose=$(VERBOSE)
...
lib/src/phy/sync/test/CMakeFiles/sync_test.dir/clean:
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -P CMakeFiles/sync_test.dir/cmake_clean.cmake
.PHONY : lib/src/phy/sync/test/CMakeFiles/sync_test.dir/clean

lib/src/phy/sync/test/CMakeFiles/sync_test.dir/depend:
	cd /local/srsLTE/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /local/srsLTE /local/srsLTE/lib/src/phy/sync/test /local/srsLTE/build /local/srsLTE/build/lib/src/phy/sync/test /local/srsLTE/build/lib/src/phy/sync/test/CMakeFiles/sync_test.dir/DependInfo.cmake --color=$(COLOR)
