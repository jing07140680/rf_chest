...
lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/psss_file_test.c.o: ../lib/src/phy/sync/test/psss_file_test.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/psss_file_test.c.o"
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/psss_file_test.dir/psss_file_test.c.o   -c /local/srsLTE/lib/src/phy/sync/test/psss_file_test.c
...
lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/psss_file_test.c.i: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /local/srsLTE/lib/src/phy/sync/test/psss_file_test.c > CMakeFiles/psss_file_test.dir/psss_file_test.c.i
...
lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/psss_file_test.c.s: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /local/srsLTE/lib/src/phy/sync/test/psss_file_test.c -o CMakeFiles/psss_file_test.dir/psss_file_test.c.s
...
lib/src/phy/sync/test/psss_file_test: lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable psss_file_test"
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/psss_file_test.dir/link.txt --verbose=$(VERBOSE)
...
lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/clean:
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -P CMakeFiles/psss_file_test.dir/cmake_clean.cmake
...
lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/depend:
	cd /local/srsLTE/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /local/srsLTE /local/srsLTE/lib/src/phy/sync/test /local/srsLTE/build /local/srsLTE/build/lib/src/phy/sync/test /local/srsLTE/build/lib/src/phy/sync/test/CMakeFiles/psss_file_test.dir/DependInfo.cmake --color=$(COLOR)
