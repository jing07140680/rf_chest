...
lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/pss_usrp.c.o: ../lib/src/phy/sync/test/pss_usrp.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/pss_usrp.c.o"
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/pss_usrp.dir/pss_usrp.c.o   -c /local/srsLTE/lib/src/phy/sync/test/pss_usrp.c
...
lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/pss_usrp.c.i: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /local/srsLTE/lib/src/phy/sync/test/pss_usrp.c > CMakeFiles/pss_usrp.dir/pss_usrp.c.i
...
lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/pss_usrp.c.s: cmake_force
	...
	cd /local/srsLTE/build/lib/src/phy/sync/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /local/srsLTE/lib/src/phy/sync/test/pss_usrp.c -o CMakeFiles/pss_usrp.dir/pss_usrp.c.s
...
lib/src/phy/sync/test/pss_usrp: /usr/lib/x86_64-linux-gnu/libsrsgui.so
...
lib/src/phy/sync/test/pss_usrp: lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable pss_usrp"
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pss_usrp.dir/link.txt --verbose=$(VERBOSE)
...
lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/clean:
	cd /local/srsLTE/build/lib/src/phy/sync/test && $(CMAKE_COMMAND) -P CMakeFiles/pss_usrp.dir/cmake_clean.cmake
.PHONY : lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/clean

lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/depend:
	cd /local/srsLTE/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /local/srsLTE /local/srsLTE/lib/src/phy/sync/test /local/srsLTE/build /local/srsLTE/build/lib/src/phy/sync/test /local/srsLTE/build/lib/src/phy/sync/test/CMakeFiles/pss_usrp.dir/DependInfo.cmake --color=$(COLOR)
