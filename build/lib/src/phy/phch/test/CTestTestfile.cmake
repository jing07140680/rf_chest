...
# Source directory: /local/srsLTE/lib/src/phy/phch/test
# Build directory: /local/srsLTE/build/lib/src/phy/phch/test
# 
...
add_test(psbch_file_test_ideal_tm2_p6_c0 "psbch_file_test" "-p" "6" "-c" "0" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p6_c0_s1.92e6.dat")
add_test(psbch_file_test_ideal_tm2_p15_c84 "psbch_file_test" "-p" "15" "-c" "84" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p15_c84_s3.84e6.dat")
add_test(psbch_file_test_ideal_tm2_p25_c168 "psbch_file_test" "-p" "25" "-c" "168" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p25_c168_s7.68e6.dat")
add_test(psbch_file_test_ideal_tm2_p50_c252 "psbch_file_test" "-p" "50" "-c" "252" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p50_c252_s15.36e6.dat")
add_test(psbch_file_test_ideal_tm2_p100_c335 "psbch_file_test" "-p" "100" "-c" "335" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p100_c335_s30.72e6.dat")
add_test(psbch_file_test_ideal_tm2_p50_c252_ext "psbch_file_test" "-p" "50" "-c" "252" "-e" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p50_c252_s15.36e6_ext.dat")
add_test(psbch_file_test_cmw_tm4_p50_c169 "psbch_file_test" "-p" "50" "-c" "169" "-t" "4" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_cmw500_f5.92e9_s11.52e6_50prb_slss_id169.dat")
...
add_test(pssch_pscch_file_test_ideal_tm2_p100 "pssch_pscch_file_test" "-p" "100" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm2_p100_c335_s30.72e6.dat")
...
add_test(pssch_pscch_file_test_ideal_tm4_p100 "pssch_pscch_file_test" "-p" "100" "-t" "4" "-s" "10" "-n" "10" "-d" "-m" "6" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_ideal_tm4_p100_c335_size10_num10_cshift0_s30.72e6.dat")
set_tests_properties(pssch_pscch_file_test_ideal_tm4_p100 PROPERTIES  PASS_REGULAR_EXPRESSION "num_decoded_sci=1")
add_test(pssch_pscch_test_tm4_p50_qc "pssch_pscch_file_test" "-p" "50" "-t" "4" "-d" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_qc9150_f5.92e9_s15.36e6_50prb_20offset.dat")
set_tests_properties(pssch_pscch_test_tm4_p50_qc PROPERTIES  PASS_REGULAR_EXPRESSION "num_decoded_sci=1 num_decoded_tb=1")
add_test(pssch_pscch_test_tm4_p50_cmw "pssch_pscch_file_test" "-p" "50" "-t" "4" "-o" "20" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_cmw500_f5.92e9_s11.52e6_50prb_0offset_1ms.dat")
set_tests_properties(pssch_pscch_test_tm4_p50_cmw PROPERTIES  PASS_REGULAR_EXPRESSION "num_decoded_sci=1 num_decoded_tb=1")
add_test(pssch_pscch_test_tm4_p50_huawei "pssch_pscch_file_test" "-p" "50" "-t" "4" "-m" "5" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_huawei_s11.52e6_50prb_10prb_offset_with_retx.dat")
...
add_test(pssch_pscch_test_tm4_p50_uxm1 "pssch_pscch_file_test" "-p" "50" "-d" "-t" "4" "-s" "5" "-n" "10" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_uxm_s15.36e6_50prb_0prb_offset_mcs12.dat")
...
add_test(pssch_pscch_test_tm4_p100_uxm2 "pssch_pscch_file_test" "-p" "100" "-t" "4" "-s" "10" "-n" "10" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_uxm_s23.04e6_100prb_1prb_offset_mcs12_padding.dat")
set_tests_properties(pssch_pscch_test_tm4_p100_uxm2 PROPERTIES  PASS_REGULAR_EXPRESSION "mcs=12.*num_decoded_sci=4")
add_test(pssch_pscch_test_tm4_p100_uxm3 "pssch_pscch_file_test" "-p" "100" "-d" "-t" "4" "-s" "10" "-n" "10" "-m" "6" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_uxm_s30.72e6_100prb_1prb_offset_mcs12_its.dat")
set_tests_properties(pssch_pscch_test_tm4_p100_uxm3 PROPERTIES  PASS_REGULAR_EXPRESSION "mcs=12.*num_decoded_sci=1")
add_test(pssch_pscch_test_tm4_p50_uxm4 "pssch_pscch_file_test" "-p" "50" "-d" "-t" "4" "-s" "5" "-n" "10" "-m" "1" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_sidelink_uxm_s15.36e6_50prb_0prb_offset_mcs28_padding_5ms.dat")
...
add_test(npbch_file_test_r13 "npbch_file_test" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_amari_nid0_sfn514_sib2.bin")
add_test(npbch_file_test_r14 "npbch_file_test" "-l" "256" "-R" "-r" "0" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_nid256_r14_sf0.bin")
add_test(npbch_file_test_nid257_r13 "npbch_file_test" "-l" "257" "-r" "4" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_nid257_r13_sf0.bin")
add_test(npbch_file_test_nid257_r14 "npbch_file_test" "-l" "257" "-R" "-r" "7" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_nid257_r14_sf0.bin")
...
add_test(pbch_file_test "pbch_file_test" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal.1.92M.dat")
add_test(pcfich_file_test "pcfich_file_test" "-c" "150" "-n" "50" "-p" "2" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal.10M.dat")
add_test(phich_file_test "phich_file_test" "-c" "150" "-n" "50" "-p" "2" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal.10M.dat")
add_test(pdcch_file_test "pdcch_file_test" "-c" "1" "-f" "3" "-n" "6" "-p" "1" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal.1.92M.amar.dat")
add_test(pdsch_pdcch_file_test "pdsch_pdcch_file_test" "-c" "1" "-f" "3" "-n" "6" "-p" "1" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal.1.92M.amar.dat")
add_test(pmch_file_test "pmch_file_test" "-i" "/local/srsLTE/lib/src/phy/phch/test/pmch_100prbs_MCS2_SR0.bin")
add_test(npdcch_formatN1_test "npdcch_test" "-o" "FormatN1")
add_test(npdcch_formatN0_file_test "npdcch_file_test" "-c" "0" "-t" "8624" "-r" "258" "-L" "1" "-l" "0" "-v" "-o" "FormatN0" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_dci_formatN0_L_1_nid0_tti_8624_rnti_0x102.bin")
add_test(npdcch_formatN1_file_test "npdcch_file_test" "-c" "0" "-t" "5461" "-r" "137" "-L" "2" "-l" "0" "-v" "-o" "FormatN1" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_dci_formatN1_nid0_tti_5461_rnti_0x89.bin")
add_test(npdsch_npdcch_dci_formatN0_test "npdsch_npdcch_file_test" "-c" "0" "-s" "4" "-w" "862" "-r" "0x102" "-v" "-o" "FormatN0" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_dci_formatN0_L_1_nid0_tti_8624_rnti_0x102.bin")
add_test(npdsch_npdcch_dci_formatN1_test "npdsch_npdcch_file_test" "-c" "0" "-s" "1" "-w" "546" "-r" "0x89" "-v" "-o" "FormatN1" "-i" "/local/srsLTE/lib/src/phy/phch/test/signal_nbiot_dci_formatN1_nid0_tti_5461_rnti_0x89.bin")
