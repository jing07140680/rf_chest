...
lib/test/common/CMakeFiles/timeout_test.dir/timeout_test.cc.o: ../lib/test/common/timeout_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object lib/test/common/CMakeFiles/timeout_test.dir/timeout_test.cc.o"
	cd /local/srsLTE/build/lib/test/common && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/timeout_test.dir/timeout_test.cc.o -c /local/srsLTE/lib/test/common/timeout_test.cc
...
lib/test/common/CMakeFiles/timeout_test.dir/timeout_test.cc.i: cmake_force
	...
	cd /local/srsLTE/build/lib/test/common && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /local/srsLTE/lib/test/common/timeout_test.cc > CMakeFiles/timeout_test.dir/timeout_test.cc.i
...
lib/test/common/CMakeFiles/timeout_test.dir/timeout_test.cc.s: cmake_force
	...
	cd /local/srsLTE/build/lib/test/common && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /local/srsLTE/lib/test/common/timeout_test.cc -o CMakeFiles/timeout_test.dir/timeout_test.cc.s
...
lib/test/common/timeout_test: lib/test/common/CMakeFiles/timeout_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/local/srsLTE/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable timeout_test"
	cd /local/srsLTE/build/lib/test/common && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/timeout_test.dir/link.txt --verbose=$(VERBOSE)
...
lib/test/common/CMakeFiles/timeout_test.dir/clean:
	cd /local/srsLTE/build/lib/test/common && $(CMAKE_COMMAND) -P CMakeFiles/timeout_test.dir/cmake_clean.cmake
.PHONY : lib/test/common/CMakeFiles/timeout_test.dir/clean

lib/test/common/CMakeFiles/timeout_test.dir/depend:
	cd /local/srsLTE/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /local/srsLTE /local/srsLTE/lib/test/common /local/srsLTE/build /local/srsLTE/build/lib/test/common /local/srsLTE/build/lib/test/common/CMakeFiles/timeout_test.dir/DependInfo.cmake --color=$(COLOR)
